...
"""
    ...
    def retrieve(self, query, similarity_method: str = "cosine"):
    ...
    def chat(self, query, retrieved_context, stream=True):
        ...
        if isinstance(retrieved_context, tuple):
            context_str, _ = retrieved_context
        else:
            context_str = retrieved_context
        
        system_prompt = self.build_instruction(context_str)
